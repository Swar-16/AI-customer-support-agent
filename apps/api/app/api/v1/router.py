...
from apps.api.app.api.v1.escalations import conversation_escalations_router, customer_escalations_router, router as escalations_router
...
def register_v1_routes(api_router: APIRouter) -> None:
    ...
    api_router.include_router(customer_escalations_router)
